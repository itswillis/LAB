...
region3 = nz.search_region("Gisborne")
print(region3)
print("Total births between 2018 and 2019: {}".format(nz.get_total_births(2018, 2019)))
print("Total deaths between 2018 and 2019: {}".format(nz.get_total_deaths(2018, 2019)))
nz.print_births_table(2018, 2019)
nz.print_deaths_table(2018, 2019)